        ...
        container.innerHTML = `
            <div class="sidenav-header">
              <i
                      ...
                      id="iconSidenav"
              ></i>
              <a type="button" class="navbar-brand m-0 border-0 no-" href="#dashboard">
                <img
                        src="./assets/img/p4-logo-dark.png"
                        class="navbar-brand-img h-100"
                        alt="main_logo"
                />
                <span class="ms-1 font-weight-bold">Postman</span>
                <small>| Horizon</small>
              </a>
            </div>
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="../pages/billing.html">
                    ...
                    <span class="nav-link-text ms-1">Entries history</span>
                  </a>
                </li> -->
                ...
                <li class="nav-item">
                  <a class="nav-link" href="#add_entry">
                    ...
                    <span class="nav-link-text ms-1">Add entry</span>
                  </a>
                </li>
                <li class="nav-item">
                  <button
                          ...
                          data-bs-target="#UploadCheatsheetModal"
                  >
                    <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
                    >
                    ...
                    <span class="nav-link-text ms-1">Upload cheatsheet</span>
                  </button>
        
                  <!-- Modal -->
                  <div
                          class="modal fade"
                          id="UploadCheatsheetModal"
                          tabindex="-1"
                          role="dialog"
                          aria-labelledby="CheatsheetModalLabel"
                          aria-hidden="true"
                  >
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="CheatsheetModalLabel">
                            Upload data cheatsheet
                          </h5>
                          <button
                                  type="button"
                ...
                <li class="nav-item">
                  ...
                  >
                    ...
                    <span class="nav-link-text ms-1">Upload images</span>
                  </button>
                  <!-- Modal -->
                  <div
                          class="modal fade"
                ...
                <li class="nav-item">
                  <a class="nav-link" href="#form8">
                    ...
                    <span class="nav-link-text ms-1">Form 8</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#form22a">
                    <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"
                    >
                      <svg
                    ...
                    <span class="nav-link-text ms-1">Form 22a</span>
                  </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="#errors">
                    ...
                    <span class="nav-link-text ms-1">Errors</span>
                  </a>
                </li>
                <!--            <li class="nav-item">-->
            ...
            <div class="sidenav-footer mx-3 mt-5">
              ...
              >
                ...
                <div class="card-body text-start p-3 w-100">
                  ...
                  >
                    <img src="./assets/img/p4-logo-dark.png" width="20"/>
                  </div>
                  <div class="docs-info">
                    <p class="text-white up mb-0">
                      Postman 4:Horizon <small>(Up.1)</small>
                    </p>
                    <p class="text-xs font-weight-bold">Explore project docs</p>
                    <a
